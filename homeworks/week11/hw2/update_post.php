...
<div class="wrapper">
  ...
  <div class="main">
    <form method="POST" action="article_update.php">
      <input type="hidden" name="id" <?php echo "value=" . $_POST['id'] ?>>
      <input type="text" name="title" placeholder="標題" <?php echo 'value=' . $_POST['title'] ?>>
      ...
      <textarea name="editorDemo"><?php echo $_POST['content'] ?></textarea>
      <button>送出</button>
    </form>
